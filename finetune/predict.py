...
class FinetunedPredictor:
    ...
    def predict(self, img_path):
        ...
        for i, pts in enumerate(landmarks):
            crop = crop_from_landmarks(img, pts, margin=2.7)
            ...
            # Labels: 0_spoof -> 0, 1_real -> 1. 2 is 'other' in the original setup but we trained on 0 and 1.
            # MultiFTNet outputs 3 classes. In our prepare_data, 1_real is label 1, 0_spoof is label 0.
...
if __name__ == "__main__":
    ...
    if res is None:
        ...
        for i, r in enumerate(res):
            print(f"Face {i}: Label={r['label']}, Real Score={r['score']:.4f}, Probs={r['probs']}")
